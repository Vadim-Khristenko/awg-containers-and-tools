...
//!
//! Selection criteria upstream, kept as-is: the host has to speak the protocol
//! being imitated, has to be reachable from Russia, and has to carry enough
//! real traffic that blocking it costs someone money.

/// QUIC Initial — hosts that answer on UDP/443.
pub const QUIC_INITIAL: &[&str] = &[
    "yandex.net",
    "yastatic.net",
    "s3.yandex.net",
...
/// QUIC 0-RTT — the subset known to issue resumption tickets.
pub const QUIC_0RTT: &[&str] = &[
    "yandex.net",
    "yastatic.net",
    "storage.yandexcloud.net",
    "vk.com",
...
/// TLS 1.3 — also the fallback pool for any profile without one.
pub const TLS_CLIENT_HELLO: &[&str] = &[
    "yandex.net",
    "yandex.ru",
    "yastatic.net",
    "s3.yandex.net",
...
/// DTLS/STUN — WebRTC and VoIP infrastructure.
pub const DTLS: &[&str] = &[
    "turn.yandex.net",
    "stun.yandex.net",
    "stun1.yandex.net",
...
/// SIP — carrier and cloud-PBX registrars.
pub const SIP: &[&str] = &[
    "sip.beeline.ru",
    "voip.beeline.ru",
    "sip.mts.ru",
...
/// DNS — resolver addresses, used as the query target.
pub const DNS: &[&str] = &[
    "77.88.8.8",
    "77.88.8.1",
    "77.88.8.88",
